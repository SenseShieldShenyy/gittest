...
namespace opeapiShow
{
    ...
    public class algorithm
    {
        ...
        public static string getSignData(byte[] allData, string secret)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string senseCloudRequest(string url, string JsonInfo, string appid, string secret)
        {
            string ttp = getTime();
            string uuid = getUUID();
